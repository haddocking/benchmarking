...
# Replace individual conformer entries with ensemble paths and write final input list
echo "[4/4] Building protein-ligand-shape-input.txt with ensemble paths..."
cp input_list.txt protein-ligand-shape-input.txt.bak
