...
- **Input list**: `prot-dna-input.txt` — generated by running `setup.sh`; lists each target with paths to protein chain(s), DNA structure files, restraint files, and the reference complex
